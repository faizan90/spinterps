...
def main():
    ...
    # plt.scatter(crd_df['Z'].values, values, alpha=0.5)

    #==========================================================================

    svgs_0 = cmpt_svgs(values)

    plt.scatter(cmpt_dist(crd_df['X'].values), svgs_0, alpha=0.1, label='X', edgecolor='none')
    plt.scatter(cmpt_dist(crd_df['Y'].values), svgs_0, alpha=0.1, label='Y', edgecolor='none')
    # plt.scatter(cmpt_dist(crd_df['Z'].values), svgs_0, alpha=0.1, label='Z')
...
def obj_ftn(prms, args):
    ...
    assert prms.size == crds_0.shape[1]
